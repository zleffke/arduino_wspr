#include <si5351.h>
#include "/home/zleffke/Arduino/libraries/Etherkit_JTEncode/src/JTEncode.h"
#include <rs_common.h>
#include <int.h>
#include <string.h>
...
void loop(){
  ...
  if (pps_fired){
    ...
    if (tx_arm){
      ...
      if (synced && s==1 && m%2==0){
        if      (m%10==0){freq=wspr_band.b160;}
        else if (m%10==2){freq=wspr_band.b80;}
